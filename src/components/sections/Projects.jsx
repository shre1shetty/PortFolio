          ...
          <div className="relative p-8 lg:p-10">
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="lg:w-1/2 flex flex-col justify-center">
                ...
                <Link to="/Project/?id=1" className="text-cyan-400 mb-3">
                  more details
                </Link>
                ...
                <div className="flex items-center gap-4">
                  ...
                  {projects[0].githubUrl && (
                    ...
                    >
                      <Button
                        variant="outline"
                        className="border-gray-700 text-gray-300 hover:border-cyan-500 hover:text-cyan-400 gap-2"
                      >
                        <Github size={16} /> Code
                      </Button>
                    </a>
          ...
          <div className="reveal opacity-0 delay-400 group glass rounded-xl p-6 hover-glow transition-all duration-500 hover:-translate-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {projects[2].technologies.slice(0, 4).map((tech, i) => (
                <span
                  key={i}
                  className="mono text-xs px-2 py-1 rounded bg-gray-800/80 text-gray-500"
                >
                  {tech}
                </span>
              ))}
